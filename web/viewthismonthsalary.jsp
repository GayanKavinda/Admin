...
<html>
    ...
    <head>
        ...
        <title>View This Month Salary</title>
    ...
    <body>
                                                    ...
                                                    <tbody>
                                                        <%
                                                            ...
                                                            for (pojo.Employee stc : stockdetails) {
                                                                ...
                                                                daycount.add(Restrictions.eq("monthz",monthz));
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td> 
                                                                <a href="salaryselctingmonth.jsp"><i class="icon-play"></i>View Summary</a>	
                                                            </td>
        ...
        <script>
            ...
            function viewattendance() {
                ...
                window.location = "SalaryHistory.jsp";
