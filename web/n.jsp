                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="footer-left">
                                    <span>&copy; 2019 <a href="http://themeforest.net/user/westilian">ITP-2019-MTR-04</a></span>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6">
                                <div class="footer-right">
                                    <span class="footer-meta">Crafted with&nbsp;<i class="fa fa-heart"></i>&nbsp;by&nbsp;<a href="http://themeforest.net/user/westilian">ITP-2019-MTR-04</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
