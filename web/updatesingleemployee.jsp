                    ...
                    <div class="container-fluid">
                        <div class="box-widget widget-module">
                            ...
                            <%
                                ...
                                String empidz = request.getParameter("empid");
                                //   System.out.println("-----------" + empidz);
                                HttpSession hs = request.getSession();

                                Session ses = util.NewHibernateUtil.getSessionFactory().openSession();
                                pojo.Employee ee = (pojo.Employee) ses.load(pojo.Employee.class, Integer.parseInt(empidz));
                                hs.setAttribute("updatedeployee", ee);
                            %>
                                ...
                                <div class=" widget-block">
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input id="empname" type="text" value=" <%= ee.getName()%>" class="form-control date-mask"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-4 control-label">Employee Address</label>
                                            <div class="col-md-8">
                                                <input id="empaddress" type="text" value=" <%= ee.getAddress()%>" class="form-control date-mask"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-4 control-label">Employee Email</label>
                                            <div class="col-md-8">
                                                <input id="empemail" type="text" value=" <%= ee.getEmail()%>" class="form-control date-mask"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-4 control-label">Position</label>
                                            <div class="col-md-8">
                                                <input disabled="" id="empposs" type="text" value=" <%= ee.getPosition()%>" class="form-control date_time-mask"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-4 control-label">Password</label>
                                            <div class="col-md-8">
                                                <input id="emppass" type="password" value=" <%= ee.getPassword()%>" class="form-control date_time-mask"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-4 control-label">Phone Number</label>
                                            <div class="col-md-8">
                                                <input id="empcontact" type="text" value=" <%= ee.getPhonenumber()%>" class="form-control date-mask"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <center>
                                                    <button  id="updateemploye" class="btn btn-success btn-block"><i class="icon-play"></i>Update Employee Details</button>	
                                                </center>
                                            </div>
                                        </div>
                                    </div>
...
//                    alert(empcontact);
                    ...
                    $.post("updateemployeedetails",
                            {
                                empoyeename: empname,
                                empoyeeaddress: empadd,
                                empoyeeemail: empemail,
                                empoyeeapassword: emppass,
                                empoyecontact: empcontact,

                            },
                            function (data, status) {


                                window.location = "employeesearch.jsp";
