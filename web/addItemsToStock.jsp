...
<html>
    ...
    <body>
                                                ...
                                                <table class="table table-striped table-hover table-bordered matmix-dt" id="myTable">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <button class="btn btn-success btn-block" onclick="addqtytostock(<%= empldet.getItemId()%>)"><i class="icon-play"></i>Add To Stock</button>	
        ...
        <script>
            ...
            function addqtytostock(vv) {


                var quantity = $('#itemqty' + vv).val();
                //alert(quantity);
