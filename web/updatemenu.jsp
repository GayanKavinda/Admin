                    ...
                    <div class="container-fluid">
                        <div class="box-widget widget-module">
                            ...
                            <%
                                ...
                                String empidz = request.getParameter("menuid");
                                //   System.out.println("-----------" + empidz);
                                HttpSession hs = request.getSession();

                                Session ses = util.NewHibernateUtil.getSessionFactory().openSession();
                                pojo.Menu ee = (pojo.Menu) ses.load(pojo.Menu.class, Integer.parseInt(empidz));
                                hs.setAttribute("updatemenuid", ee);
                            %>
                            <div class="widget-container">
                                <div class=" widget-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input id="empname" type="text" value=" <%= ee.getFoodName()%>" class="form-control date-mask" disabled=""/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Menu Type</label>
                                        <div class="col-md-8">
                                            <input id="empaddress" type="text" value=" <%= ee.getMenuType()%>" class="form-control date-mask" disabled=""/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input id="menuunitp" type="text" value=" <%= ee.getPrice()%>" class="form-control date_time-mask"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <center>
                                                <button  id="updatemyn" class="btn btn-success btn-block" onclick="updMenu()"><i class="icon-play"></i>Update Menu Details</button>	
                                                <button  id="updatemyn" class="btn btn-danger btn-block" onclick="delmenu()"><i class="icon-play"></i>Delete Menu </button>	
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="footer-left">
                                    <span>&copy; 2019 <a href="http://themeforest.net/user/westilian">ITP_2019_MTR_4</a></span>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6">
                                <div class="footer-right">
                                    <span class="footer-meta">Crafted with&nbsp;<i class="fa fa-heart"></i>&nbsp;by&nbsp;<a href="http://themeforest.net/user/westilian">ITP_2019_MTR_4</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            function updMenu() {
                ...
                yewxmlhttp.onreadystatechange = function() {
                    ...
                    if (yewxmlhttp.readyState == 4 && yewxmlhttp.status == 200) {
                        ...
                        if (gett === "ok") {
                            //   alert("inside if");
                            swal("Done!", "Unit Price Updated..!", "success");
                            window.location = "viewMenu.jsp";
                ...
                var unitprice = document.getElementById("menuunitp").value;
            ...
            function delmenu() {
                ...
                yewxmlhttp.onreadystatechange = function() {
                    ...
                    if (yewxmlhttp.readyState == 4 && yewxmlhttp.status == 200) {
                        ...
                        if (gett === "ok") {
                            //   alert("inside if");
                            swal("Done!", "Menu Deleted..!", "success");
                            window.location = "viewMenu.jsp";
                ...
                yewxmlhttp.open("POST", "dltemenu", true);
                yewxmlhttp.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
