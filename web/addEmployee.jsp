                                ...
                                <div class=" widget-block">
                                    <form class="form-horizontal"  >
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input id="empname" type="text" class="form-control date-mask"required />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-4 control-label">Employee Address</label>
                                            <div class="col-md-8">
                                                <input id="empaddress" type="text" class="form-control date-mask"required />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-4 control-label">Employee Email</label>
                                            <div class="col-md-8">
                                                <input id="empemail" type="text" class="form-control date-mask" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-4 control-label">Position</label>
                                            <div class="col-md-8">
                                                <select id="emppositon" class="form-control time-mask">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input id="emppass" type="text" class="form-control date_time-mask" required />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-4 control-label">Phone Number</label>
                                            <div class="col-md-8">
                                                <input id="empcontact" type="text" class="form-control date-mask" required/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <center>
                                                    <button  id="saveemploye" class="btn btn-success btn-block" onclick="formValidation()"><i class="icon-play"  ></i>Save Employee</button>	
                                                </center>
                                            </div>
                                        </div>
                                    </form>
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#saveemploye").click(function () {
                    ...
                    var empposition = $('#emppositon').val();
