...
<html>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="footer-left">
                                    <span>&copy; 2019 <a href="group.jsp">ITP-2019-MTR-04</a></span>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6">
                                <div class="footer-right">
                                    <span class="footer-meta">Crafted with&nbsp;<i class="fa fa-heart"></i>&nbsp;by&nbsp;<a href="group.jsp">ITP-2019-MTR-04</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Mirrored from www.lab.westilian.com/matmix-admin/iconic-view/index.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 May 2018 11:49:11 GMT -->
</html>