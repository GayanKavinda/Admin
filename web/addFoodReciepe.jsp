                                ...
                                <div class=" widget-block">
                                    <form class="form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input id="foodname" type="text" class="form-control date-mask"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <center>
                                                    <button  id="bt1" class="btn btn-success btn-block"><i class="icon-play"></i>Save Food</button>	
                                                </center>
                                            </div>
                                        </div>
                                    </form>
                ...
                $("#bt1").click(function() {
                    ...
                    function(data, status) {
                        ...
                        if (data == "ok") {
                            ...
                            window.location = "addFoodReciepe.jsp";
