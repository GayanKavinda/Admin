                                ...
                                <div class=" widget-block">
                                    <form class="form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input id="itemname" type="text" class="form-control date-mask"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-4 control-label">Item Category</label>
                                            <div class="col-md-8">
                                                <select id="cate" class="form-control time-mask">
                                                    <option>Cate 01</option>
                                                    <option>Cate 02</option>
                                                    <option>Cate 03</option>
                                                    <option>Cate 05</option>
                                                    <option>Cate06</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input id="unp" type="number" class="form-control date_time-mask"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <center>
                                                    <button  id="bt1" class="btn btn-success btn-block"><i class="icon-play"></i>Save Item</button>	
                                                </center>
                                            </div>
                                        </div>
                                    </form>
        ...
        <script>
            $(document).ready(function() {
                $("#bt1").click(function() {
                    ...
                    var catgory = $('#cate').val();
                    
                    var uniprise = $('#unp').val();
//                    alert(iname);
//                    alert(catgory);
