        ...
        <div class="page-container iconic-view">
                                                ...
                                                <table class="table table-striped table-hover table-bordered matmix-dt" id="myTable">
                                                    ...
                                                    <tbody>
                                                        <%
                                                            ...
                                                            Criteria criteria = ses.createCriteria(Review.class);
                                                            // criteria.add(Restrictions.eq("name", "kushan"));
                                                            List<pojo.Review> employeedetails = criteria.list();
                                                            for (pojo.Review empldet : employeedetails) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <button class="btn btn-danger btn-block" onclick="deletecomment(<%= empldet.getReviewId() %>)"><i class="icon-play"></i>Delete</button>	
            ...
            <script>
                function deletecomment(cc) {
                    ...
                    yewxmlhttp.onreadystatechange = function() {
                        ...
                        if (yewxmlhttp.readyState == 4 && yewxmlhttp.status == 200) {
                            ...
                            if (gett === "ok") {
                                ...
                                window.location = "viewComments.jsp";
                    ...
                    yewxmlhttp.open("POST", "deletecomment", true);
