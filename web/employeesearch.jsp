        ...
        <div class="page-container iconic-view">
                                                ...
                                                <table class="table table-striped table-hover table-bordered matmix-dt" id="myTable">
                                                    ...
                                                    <tbody>
                                                        <%
                                                            ...
                                                            List<pojo.Employee> employeedetails = criteria.list();
                                                            for (pojo.Employee empldet : employeedetails) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <%= empldet.getPhonenumber()%>

                                                            </td>
                                                            <td>
                                                                <button class="btn btn-warning btn-block" onclick="sendtoUpdate(<%= empldet.getEid()%>)"><i class="icon-play"></i>Edit</button>	
                                                                <button class="btn btn-danger btn-block" onclick="deleemployee(<%= empldet.getEid()%>)"><i class="icon-play"></i>Delete</button>	
            ...
            <script>
                function deleemployee(cc) {
                    ...
                    yewxmlhttp.open("POST", "deleteEmp", true);
