    ...
    <body>
                                                ...
                                                <table class="table table-striped table-hover table-bordered matmix-dt" id="myTable">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td> 
                                                                <button  id="bt1" class="btn btn-success btn-block" onclick="markattendance(<%= it.getEid() %>)"><i class="icon-play"></i>Mark Attendance</button>	
                                                            </td>
        ...
        <script>
            ...
            function markattendance(zz) {
                ...
                yewxmlhttp.onreadystatechange = function() {
                    ...
                    if (yewxmlhttp.readyState == 4 && yewxmlhttp.status == 200) {
                        ...
                        if (gett === "ok") {
                            ...
                            alert("Attendance Alredy Marked For this Employee Today...!");
                        }
                ...
                yewxmlhttp.open("POST", "markattendance", true);
