...
<html>
    ...
    <head>
        ...
        <title>View Sent Message To Suppliers</title>
                                                ...
                                                <div class="col-md-6">
                                                    <form class="form-horizontal">
                                                        <div class="form-group">
                                                            <label class="col-md-6 control-label">Supplier Search:</label>
                                                            <div class=" col-md-6">
                                                ...
                                                <table class="table table-striped table-hover table-bordered matmix-dt" id="myTable">
                                                    ...
                                                    <tbody>
                                                        <%
                                                            ...
                                                            Criteria gg = sessionz.createCriteria(pojo.Sndmessagetosupplier.class);
                                                            List<pojo.Sndmessagetosupplier> stockdetails = gg.list();
                                                            for (pojo.Sndmessagetosupplier stc : stockdetails) {

                                                                int itemid = stc.getIdmessage();
