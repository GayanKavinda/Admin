                                ...
                                <div class=" widget-block">
                                    <form class="form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input id="slotname" type="text" class="form-control date-mask"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <center>
                                                    <button  id="bt1" class="btn btn-success btn-block"><i class="icon-play"></i>Save Slot</button>	
                                                </center>
                                            </div>
                                        </div>
                                    </form>
