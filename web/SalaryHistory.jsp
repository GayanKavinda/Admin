    ...
    <body>
                                        ...
                                        <div class="widget-block">
                                                ...
                                                <div class="col-md-6">
                                                    <form class="form-horizontal">
                                                        <div class="form-group">
                                                            <label class="col-md-6 control-label">Type Month</label>
                                                            <div class=" col-md-6">
                                            ...
                                            <diSv class="table-responsive">
                                                <table class="table table-striped table-hover table-bordered matmix-dt" id="myTable">
                                                    ...
                                                    <tbody>
                                                        <%
                                                             String masethorapu = request.getParameter("salmon");
                                                             System.out.print("month---" + masethorapu);
                                                            Session sessionz = util.NewHibernateUtil.getSessionFactory().openSession();
                                                            Criteria gg = sessionz.createCriteria(pojo.Employee.class);
                                                            List<pojo.Employee> stockdetails = gg.list();
                                                            for (pojo.Employee stc : stockdetails) {

                                                                int employeeid = stc.getEid();
                                                                System.out.print("Emp id---" + employeeid);
                                                                pojo.Employee it = (pojo.Employee) sessionz.load(pojo.Employee.class, employeeid);
                                                                
                                                                
                                                                
                                                                Criteria daycount = sessionz.createCriteria(pojo.Attendancemarking.class);
                                                                daycount.add(Restrictions.eq("employeeid",""+employeeid));
                                                                daycount.add(Restrictions.eq("monthz",masethorapu));
                                                                List<pojo.Attendancemarking> empcount= daycount.list();
                                                                
                                                                int finalcount = empcount.size();
                                                                double salaryperday = Double.parseDouble(stc.getPassword());
                                                                
                                                                double finalsalary = finalcount * salaryperday;
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td> 
                                                                <button  id="bt1" class="btn btn-success btn-block" onclick="viewattendance()"><i class="icon-play"></i>View Summary</button>	
                                                            </td>
        ...
        <script>
            ...
            function viewattendance() {
                ...
                window.location = "salaryselctingmonth.jsp";
